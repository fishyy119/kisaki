...
This directory is the source of truth for release changelog content. Changelogs are
reader-facing release notes, not commit summaries or code ownership reports.
