...
function printUsage(receivedCommand: string | undefined): void {
  ...
  console.log(`Usage:
  tsx scripts/extension-tooling/cli.ts check [version]
  tsx scripts/extension-tooling/cli.ts set-version <version>
  tsx scripts/extension-tooling/cli.ts build
  tsx scripts/extension-tooling/cli.ts verify-output
  tsx scripts/extension-tooling/cli.ts pack [--out-dir <dir>]
  tsx scripts/extension-tooling/cli.ts publish [--dir <dir>] [--dry-run] [--provenance] [--tag <tag>]
  tsx scripts/extension-tooling/cli.ts list`)
}
