/**
 * Novel volume completion: the renderer-side writes to volume read state,
 * shared by volume rows, the volume detail dialog, and catch-up.
 *
...
import { novelVolumes, type MediaStatus, type NovelVolume } from '@shared/db'
