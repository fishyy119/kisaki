<!--
  ...
  Dialog for editing character external IDs.
-->
...
import { characterExternalIds } from '@shared/db'
...
watch(results, (data) => {
  ...
  items.value = data.map((item) => ({
    ...
    orderInCharacter: item.orderInCharacter
  }))
})
...
<template>
  ...
  <CharacterExternalIdItemFormDialog
    v-if="itemFormOpen"
