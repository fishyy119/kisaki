...
const searchProviderSource = useSearchProviderSource(selectedProfileId, 'company')
 ...
 */
const searchResults = shallowRef<CompanySearchResult[]>([])
...
watch(
  [selectedProfileId, searchProviderSource, companyId, searchResults, selectedResultId],
  () => {
