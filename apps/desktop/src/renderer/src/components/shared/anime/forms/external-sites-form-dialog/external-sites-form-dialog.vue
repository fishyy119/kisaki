<!--
  ...
  Dialog for editing anime related sites/links.
-->
...
import AnimeExternalSitesItemFormDialog from './external-site-item-form-dialog.vue'
...
watch(anime, (animeData) => {
  if (animeData) {
    sites.value = animeData.externalSites || []
  }
})
