<!--
  Anime Detail Activity Distribution

  Shows watch time distribution by hour of day, weekday, or day of month.
  Uses TimeDistributionChart UI component with sessions from anime context.
-->
  ...
  switch (distributionType.value) {
    ...
    case 'dayOfMonth': {
      ...
      return values.map((value, i) => ({
        key: i + 1,
        label: m.value.anime.activity.dayOfMonthLabel({ day: i + 1 }),
        value
      }))
    }
    default: {
