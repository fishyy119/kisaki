<!--
  ...
  Dialog for editing anime last watched time.
-->
...
watch(anime, (animeData) => {
  if (animeData) {
    formData.value.datetime = formatDatetimeLocalInput(animeData.lastActiveAt)
  }
})
...
<template>
  <Dialog v-model:open="open">
    <DialogContent class="max-w-md">
      ...
      <template v-else>
        <DialogHeader>
          <DialogTitle>{{ m.anime.lastActiveDialog.title }}</DialogTitle>
        </DialogHeader>
        <Form @submit="handleSubmit">
          <DialogBody>
            <FieldGroup>
              <Field>
                <FieldLabel>{{ m.anime.lastActiveDialog.label }}</FieldLabel>
                <FieldContent>
                ...
                <FieldDescription>{{ m.anime.lastActiveDialog.emptyHint }}</FieldDescription>
              </Field>
            </FieldGroup>
          </DialogBody>
          <DialogFooter>
