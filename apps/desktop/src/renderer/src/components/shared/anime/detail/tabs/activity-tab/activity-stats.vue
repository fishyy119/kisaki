<!--
  Anime Detail Activity Stats

  Statistics summary for a single anime's watch history.
-->
...
const items = computed<StatsGridItem[]>(() => [
  {
    ...
    label: m.value.anime.activity.watchDuration,
    value: f.value.duration(stats.value.totalDuration)
  },
  {
    icon: 'icon-[mdi--play-circle-outline]',
    label: m.value.anime.activity.sessionCount,
    value: m.value.anime.activity.sessionCountValue({ count: stats.value.totalSessions })
  },
  {
    icon: 'icon-[mdi--timer-sand-paused]',
    label: m.value.anime.activity.avgDuration,
    value: f.value.duration(stats.value.averageSessionDuration)
  },
  {
    icon: 'icon-[mdi--trophy-variant-outline]',
    label: m.value.anime.activity.longestSession,
    value: f.value.duration(stats.value.longestSession)
  },
  {
    icon: 'icon-[mdi--lightbulb-variant-outline]',
    label: m.value.anime.activity.currentStreak,
    value: m.value.anime.activity.streakValue({ days: stats.value.currentStreak })
  },
  {
    icon: 'icon-[mdi--medal-outline]',
    label: m.value.anime.activity.longestStreak,
    value: m.value.anime.activity.streakValue({ days: stats.value.longestStreak })
  },
  {
    icon: 'icon-[mdi--calendar-start-outline]',
    label: m.value.anime.activity.firstWatched,
  ...
  },
  {
    ...
    label: m.value.anime.activity.lastWatched,
