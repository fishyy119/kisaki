<!--
  PersonGamesItem
  Single game item component showing cover, name, note, and action buttons.
-->
...
const coverUrl = computed(() =>
  props.gameCover
    ? getAttachmentUrl('games', props.gameId, props.gameCover, { width: 100, height: 100 })
    : null
)

const displayName = computed(() => (spoilerHidden.value ? '剧透内容' : props.gameName))
