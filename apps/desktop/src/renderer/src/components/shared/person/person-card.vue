...
interface Props {
  ...
  // Card variant props
  size?: MediaCardSize
  /** Secondary line under the name, such as the characters this person plays */
  subtitle?: string
  hideName?: boolean
  badgeLabel?: string
...
const imageUrl = computed(() =>
  getEntityImageUrl('person', props.person, 'cover', { width: 300, height: 400 })
)
</script>
