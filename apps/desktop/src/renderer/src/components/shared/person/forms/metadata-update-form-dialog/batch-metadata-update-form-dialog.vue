<!--
  ...
  Batch update person metadata through renderer-local lookup plus the main-process ingest service.
-->
...
import { personExternalIds, persons, scraperProfiles } from '@shared/db'
