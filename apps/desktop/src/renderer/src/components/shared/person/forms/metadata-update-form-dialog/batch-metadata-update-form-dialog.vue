<!--
  ...
  Starts a main-process batch metadata update for selected persons.
-->
...
async function handleSubmit() {
  ...
  try {
    const result = await ipcManager.invoke('ingest:batch-update-person-from-scraper', request)
    if (!result.success) {
