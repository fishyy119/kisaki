<!--
  ComicCard
  Pure display component for rendering a comic entry in lists/grids.
...
const imageUrl = computed(() =>
  getEntityImageUrl('comic', props.comic, 'cover', { width: 300, height: 400 })
)
</script>
...
<template>
  ...
  >
    <MediaCard
      ...
      :image-url="imageUrl"
      :fallback-icon="getEntityIcon('comic')"
      :size="props.size"
      :align="props.align"
