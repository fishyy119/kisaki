<!--
  ...
  Dialog for editing game external IDs.
-->
...
import { gameExternalIds } from '@shared/db'
...
async function handleSave() {
  ...
  try {
    ...
    await db.delete(gameExternalIds).where(eq(gameExternalIds.gameId, props.gameId))
