<!--
  SettingsSection - Groups related settings under a heading with an optional
  actions group, in the compact settings rhythm. The `rows` surface is the
  multi-section settings recipe: the section's fields sit in one bordered,
  divider-separated column so several sections on one surface stay distinct
  and scannable. Plain sections carry content that frames itself, such as data
  lists, action rows, or documentation. Mirror of the extension kit component.
-->
