...
import type { ExtensionResolvedSettingsNoticeNode } from '@shared/extension'

const props = defineProps<{
  node: ExtensionResolvedSettingsNoticeNode
}>()
...
<template>
  <div :class="noticeClass">{{ props.node.text }}</div>
</template>
