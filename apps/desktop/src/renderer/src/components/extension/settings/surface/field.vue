...
import type { ExtensionResolvedSettingsField, ExtensionSettingsSurface } from '@shared/extension'

defineOptions({
  name: 'ExtensionSettingsField'
})

const props = defineProps<{
  field: ExtensionResolvedSettingsField
...
const orientation = computed(() =>
  props.field.orientation === 'horizontal' ? 'horizontal' : 'vertical'
)
