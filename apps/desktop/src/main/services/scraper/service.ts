...
import { TvScraperHandler } from './handlers/tv'
import { MovieScraperHandler } from './handlers/movie'
...
export class ScraperService implements IContentService {
  ...
  async init(container: ServiceInitContainer<this>): Promise<void> {
    ...
    this.tv = new TvScraperHandler(db, i18n, this.hooks.tv)
    this.movie = new MovieScraperHandler(db, i18n, this.hooks.movie)
