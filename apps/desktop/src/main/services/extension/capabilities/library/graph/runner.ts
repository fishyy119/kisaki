...
export interface ExtensionLibraryGraphRunnerOptions {
  db: DbService
...
export class ExtensionLibraryGraphRunner {
  constructor(private readonly options: ExtensionLibraryGraphRunnerOptions) {}
