...
export const library = {
  ...
  fields: {
    ...
    characterPersons: '角色关联人物',
    cast: '声优阵容',
    voicedBy: '配音',
    voiceCredits: '配音作品',
    companyRelations: '公司关系',
    externalSites: '外部链接',
    externalIds: '外部 ID',
    photos: '照片',
    covers: '封面',
  ...
  detail: {
    ...
    collectionEmptyDescription: ({ label }: { label: string }) => `通过扫描器添加${label}到此合集`,
  ...
  forms: {
    ...
    castPersonLabel: '声优',
    castEmptyHint: '暂无声优阵容，使用下方按钮添加',
    castDuplicate: '该角色与声优在本条目中已配对',
    ...
    importMediaFromUrlDescription: ({ label }: { label: string }) => `输入图片 URL 以导入${label}`,
    imageUrlLabel: '图片链接',
    ...
    collectionStrategyReplaceHint: '以新内容整体替换当前内容；数据源明确为空的集合将被清空',
