...
declare const baseColumns: {
  ...
  createdAt: drizzle_orm0.HasRuntimeDefault<
    drizzle_orm0.HasDefault<
      drizzle_orm0.NotNull<drizzle_orm_sqlite_core321.SQLiteTimestampBuilderInitial<'created_at'>>
    >
  >
  updatedAt: drizzle_orm0.HasDefault<
    drizzle_orm0.HasRuntimeDefault<
      drizzle_orm0.HasDefault<
        drizzle_orm0.NotNull<drizzle_orm_sqlite_core321.SQLiteTimestampBuilderInitial<'updated_at'>>
      >
    >
  >
}
...
//#endregion
//#region src/renderer/src/composables/use-entity-delete.d.ts
 ...
 */
declare function useEntityDelete(options: UseEntityDeleteOptions): {
  data: Ref<EntityDeletePreview | undefined, EntityDeletePreview | undefined>
  isLoading: Ref<boolean, boolean>
  items: ComputedRef<EntityDeletePreviewItem[]>
  relatedOptions: ComputedRef<EntityDeletePreviewOption[]>
  selectedRelatedTypes: Ref<AllEntityType[], AllEntityType[]>
  resolvedEntityIds: ComputedRef<string[]>
  count: ComputedRef<number>
  firstName: ComputedRef<string>
  entityName: ComputedRef<string>
  previewNames: ComputedRef<string[]>
  deleteSelectedEntities: () => Promise<EntityDeleteResult>
}
//#endregion
  ...
  Pick<
    {
      ...
      >
      initialized: vue0.Ref<boolean, boolean>
      isInstalling: vue0.Ref<boolean, boolean>
      isManuallyChecking: vue0.Ref<boolean, boolean>
      isStartingDownload: vue0.Ref<boolean, boolean>
      hasDownloadedUpdate: vue0.ComputedRef<boolean>
      isChecking: vue0.ComputedRef<boolean>
      isDownloading: vue0.ComputedRef<boolean>
      canStartDownload: vue0.ComputedRef<boolean>
      downloadProgress: vue0.ComputedRef<{
        bytesPerSecond: number
        percent: number
        transferred: number
        total: number
      } | null>
      release: vue0.ComputedRef<{
        version: string
        releaseName: string | null
        releaseDate: string | null
      } | null>
      activeReleaseVersion: vue0.ComputedRef<string | null>
      activeChangelog: vue0.ComputedRef<AppUpdaterChangelogBundle | null>
      isActiveChangelogLoading: vue0.ComputedRef<boolean>
      activeChangelogError: vue0.ComputedRef<string | null>
      changelogByVersion: vue0.Ref<
        Record<string, AppUpdaterChangelogBundle>,
        Record<string, AppUpdaterChangelogBundle>
      >
      changelogLoadingByVersion: vue0.Ref<Record<string, boolean>, Record<string, boolean>>
      changelogErrorByVersion: vue0.Ref<
      ...
      ensureActiveReleaseChangelog: (options?: {
        force?: boolean
