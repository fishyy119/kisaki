<!-- Automation Tab creates recommended app-owned automations for Google Books commands. -->
<script setup lang="ts">
import { ref } from 'vue'
import { Badge, Button, Icon, SettingsSection, Spinner } from '@kisaki3/extension-ui-vue'
import type { GbooksAutomationKind, GbooksSettingsOverview } from '../../../shared/settings'
import { m } from '../i18n'
...
interface Props {
  overview: GbooksSettingsOverview
}
...
const creatingKind = ref<GbooksAutomationKind | null>(null)

async function create(kind: GbooksAutomationKind): Promise<void> {
