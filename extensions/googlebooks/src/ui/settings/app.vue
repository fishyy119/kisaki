<!--
Google Books Settings App is the webview root: it loads the overview, owns the
...
import {
  ...
  type GbooksSettingsFormState,
  type GbooksSettingsOverview
...
const overview = ref<GbooksSettingsOverview | null>(null)
const savedForm = ref<GbooksSettingsFormState | null>(null)
...
// A rejected relay URL would silently fall back to the default on save.
const isValid = computed(() => matchesHttpUrlFormat(settingsForm.oauthRelayUrl))
