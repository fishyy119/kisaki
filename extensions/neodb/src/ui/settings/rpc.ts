...
import { m } from './i18n'
import type { NeodbSettingsHostFunctions, NeodbSettingsUiFunctions } from '../../shared/settings'

type RefreshListener = (reason: string) => void

const refreshListeners = new Set<RefreshListener>()

export const host = createWebviewRpc<NeodbSettingsHostFunctions, NeodbSettingsUiFunctions>(
  webview,
  {
