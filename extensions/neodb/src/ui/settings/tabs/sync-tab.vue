  ...
  <div class="space-y-4">
    ...
    >
      <FieldGroup>
        ...
        <Field
          orientation="horizontal"
          :label="m.ui.sync.visibilityLabel"
          :description="m.ui.sync.visibilityDescription"
        >
          <Select v-model="settingsForm.syncVisibility">
            ...
            <SelectContent>
              <SelectItem value="self">{{ m.ui.sync.visibilitySelf }}</SelectItem>
              <SelectItem value="followers">{{ m.ui.sync.visibilityFollowers }}</SelectItem>
              <SelectItem value="public">{{ m.ui.sync.visibilityPublic }}</SelectItem>
            </SelectContent>
          </Select>
        </Field>
      </FieldGroup>
