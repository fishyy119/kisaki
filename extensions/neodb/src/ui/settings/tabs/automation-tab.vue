<!-- Automation Tab creates recommended app-owned automations for NeoDB commands. -->
<script setup lang="ts">
import { ref } from 'vue'
import { Badge, Button, Icon, SettingsSection, Spinner } from '@kisaki3/extension-ui-vue'
import type { NeodbAutomationKind, NeodbSettingsOverview } from '../../../shared/settings'
import { m } from '../i18n'
...
const creatingKind = ref<NeodbAutomationKind | null>(null)

async function create(kind: NeodbAutomationKind): Promise<void> {
