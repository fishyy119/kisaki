<!-- Maintenance Tab edits the instance, client preferences, and destructive resets. -->
...
const isDefaultInstance = (): boolean => settingsForm.instanceUrl === NEODB_DEFAULT_INSTANCE_URL

function restoreInstance(): void {
  settingsForm.instanceUrl = NEODB_DEFAULT_INSTANCE_URL
}
...
<template>
  <div class="space-y-4">
    <SettingsSection
      :title="m.ui.maintenance.instanceTitle"
      :description="m.ui.maintenance.instanceDescription"
      surface="rows"
    >
      <FieldGroup>
        <Field
          orientation="horizontal"
          :label="m.ui.maintenance.instanceUrlLabel"
          :description="m.ui.maintenance.instanceUrlDescription"
        >
          <Input
            v-model="settingsForm.instanceUrl"
            type="url"
            autocomplete="off"
            spellcheck="false"
            :placeholder="NEODB_DEFAULT_INSTANCE_URL"
            class="w-80"
          />
        </Field>
      </FieldGroup>
