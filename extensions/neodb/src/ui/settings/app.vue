<!--
NeoDB Settings App is the webview root: tab navigation, preference draft
...
import {
  ...
  type NeodbSettingsFormState,
  type NeodbSettingsOverview
...
const overview = ref<NeodbSettingsOverview | null>(null)
const savedForm = ref<NeodbSettingsFormState | null>(null)
...
// A rejected instance URL would silently fall back to the default on save.
const isValid = computed(() => matchesHttpUrlFormat(settingsForm.instanceUrl))
