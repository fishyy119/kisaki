<!-- Preferences Section edits artwork and client behaviour, plus a settings reset. -->
  ...
  >
    <FieldGroup>
      <Field
        ...
        :label="m.ui.preferences.includeNsfwLabel"
        :description="m.ui.preferences.includeNsfwDescription"
      >
        <Switch v-model="settingsForm.includeNsfw" />
      </Field>
