<!--
SteamGridDB Settings App is the webview root: it loads the overview, owns the
preference draft lifecycle, and surfaces load and action errors.
-->
<script setup lang="ts">
import { computed, onMounted, ref } from 'vue'
import { Alert, Button, Spinner, WebviewDialogShell } from '@kisaki3/extension-ui-vue'
import type { SgdbSettingsFormState, SgdbSettingsOverview } from '../../shared/settings'
...
const overview = ref<SgdbSettingsOverview | null>(null)
const savedForm = ref<SgdbSettingsFormState | null>(null)
