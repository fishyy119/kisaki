<!--
MyAnimeList Settings App is the webview root: it loads the overview, owns the
...
import {
  ...
  type MalSettingsFormState,
  type MalSettingsOverview
...
const overview = ref<MalSettingsOverview | null>(null)
const savedForm = ref<MalSettingsFormState | null>(null)
...
const isValid = computed(
  () =>
    matchesHttpUrlFormat(settingsForm.apiUrl) &&
