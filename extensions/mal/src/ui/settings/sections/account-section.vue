<!--
Account Section owns the direct PKCE sign-in lifecycle: starting the browser
login, cancelling a pending one, verifying the stored token, and signing out.
A missed browser callback has nothing to resume; the user starts over.
-->
