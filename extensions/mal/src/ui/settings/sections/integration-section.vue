<!--
Integration Section owns the MAL list connection: automatic push preferences,
the manual full push, and the list import across the anime and manga lists.
Long operations run as app task runs; this section starts them and polls a
small projection until they settle.
-->
...
import type { MalProfileOptions, MalTaskStateView } from '../../../shared/settings'
