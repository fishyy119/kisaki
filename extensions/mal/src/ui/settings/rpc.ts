...
import { m } from './i18n'
import type { MalSettingsHostFunctions, MalSettingsUiFunctions } from '../../shared/settings'

type RefreshListener = (reason: string) => void

const refreshListeners = new Set<RefreshListener>()

export const host = createWebviewRpc<MalSettingsHostFunctions, MalSettingsUiFunctions>(webview, {
