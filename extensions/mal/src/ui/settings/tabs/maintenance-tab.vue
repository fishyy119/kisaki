<!-- Maintenance Tab edits the endpoints, client preferences, and destructive resets. -->
  ...
  <div class="space-y-4">
    ...
    >
      <FieldGroup>
        <Field
          ...
          :label="m.ui.maintenance.apiUrlLabel"
          :description="m.ui.maintenance.apiUrlDescription"
        >
          <Input
        ...
        <Field
          orientation="horizontal"
          :label="m.ui.maintenance.mirrorEnabledLabel"
          :description="m.ui.maintenance.mirrorEnabledDescription"
        >
        ...
        <Field
          ...
          orientation="horizontal"
          :label="m.ui.maintenance.mirrorUrlLabel"
          :description="m.ui.maintenance.mirrorUrlDescription"
        >
          <Input
      ...
      <template #actions>
        <Button
          ...
          size="sm"
          type="button"
          :disabled="isDefaultEndpoints()"
          @click="restoreEndpoints"
        >
          <Icon
    ...
    >
      <FieldGroup>
        <Field
          orientation="horizontal"
          :label="m.ui.maintenance.preferRomajiLabel"
          :description="m.ui.maintenance.preferRomajiDescription"
        >
          <Switch v-model="settingsForm.preferRomajiTitles" />
        </Field>
