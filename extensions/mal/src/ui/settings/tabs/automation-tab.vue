<!-- Automation Tab creates recommended app-owned automations for MyAnimeList commands. -->
<script setup lang="ts">
import { ref } from 'vue'
import { Badge, Button, Icon, SettingsSection, Spinner } from '@kisaki3/extension-ui-vue'
import type { MalAutomationKind, MalSettingsOverview } from '../../../shared/settings'
import { m } from '../i18n'
...
const creatingKind = ref<MalAutomationKind | null>(null)

async function create(kind: MalAutomationKind): Promise<void> {
