 ...
 * `/open/archive/search-org` answers code 404). So this provider declares no
 * `search` capability and answers exclusively for entities carrying a YMGal
 * id — which is how they arrive, since a game scrape writes the developer's
 * id.
 */
