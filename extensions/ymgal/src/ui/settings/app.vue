<!--
YMGal Settings App is the webview root: it loads the overview, owns the
...
import {
  ...
  type YmgalSettingsFormState,
  type YmgalSettingsOverview
...
const overview = ref<YmgalSettingsOverview | null>(null)
const savedForm = ref<YmgalSettingsFormState | null>(null)
...
const isValid = computed(() => matchesHttpUrlFormat(settingsForm.apiBaseUrl))
