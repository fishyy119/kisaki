<!-- Preferences Section edits naming and client behaviour, plus a settings reset. -->
  ...
  >
    <FieldGroup>
      <Field
        ...
        :label="m.ui.preferences.preferChineseLabel"
        :description="m.ui.preferences.preferChineseDescription"
      >
        <Switch v-model="settingsForm.preferChineseNames" />
      </Field>
