...
import {
  ...
  type IgdbSettingsFormState,
  type IgdbSettingsOverview
...
const overview = ref<IgdbSettingsOverview | null>(null)
const savedForm = ref<IgdbSettingsFormState | null>(null)
...
const isValid = computed(
  () => matchesHttpUrlFormat(settingsForm.apiBaseUrl) && matchesHttpUrlFormat(settingsForm.oauthUrl)
)
