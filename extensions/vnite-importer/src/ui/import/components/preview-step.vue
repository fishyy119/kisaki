  ...
  <div class="space-y-4">
    ...
    <section class="space-y-2">
      ...
      <div class="overflow-hidden rounded-md border border-border">
        <div class="flex items-center justify-between border-b border-border bg-surface/60 px-3 py-2">
        ...
        <div class="flex items-center justify-between border-t border-border bg-surface/40 px-3 py-2">
          <span class="text-xs text-muted-foreground">
