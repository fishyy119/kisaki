...
function toPreviewDto(preview: VniteWizardPreview, queryInput: VnitePreviewQueryDto): VnitePreviewDto {
...
function normalizePreviewActionFilter(action: VnitePreviewActionFilterDto): VnitePreviewActionFilterDto {
  if (action === 'all') {
    return 'all'
  }
