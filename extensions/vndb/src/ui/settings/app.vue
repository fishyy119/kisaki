<!--
VNDB Settings App is the webview root: tab navigation, preference draft
...
import {
  ...
  type VndbSettingsFormState,
  type VndbSettingsOverview
...
const savedForm = ref<VndbSettingsFormState | null>(null)
