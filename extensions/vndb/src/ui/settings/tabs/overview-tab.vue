...
import type { VndbSettingsOverview } from '../../../shared/settings'
...
const accountLabel = computed(() =>
  props.overview.credential.configured
    ? m.value.ui.overview.tokenConfigured
    : m.value.ui.overview.anonymous
)
...
const accountBadge = computed<{ label: string; variant: BadgeVariants['variant'] }>(() =>
  props.overview.credential.configured
    ...
    : { label: m.value.ui.overview.anonymous, variant: 'secondary' }
)
