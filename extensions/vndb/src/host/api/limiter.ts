 ...
 *
 * VNDB documents 200 requests per 5 minutes for an unauthenticated client, and
 * one scrape fans out into character, staff, producer, tag, and trait reads,
 * so requests are paced here instead of relying on 429 retries alone.
 */
export class VndbRateLimiter {
