<!--
AniList Settings App is the webview root: it loads the overview, owns the
...
const isValid = computed(
  () =>
    matchesHttpUrlFormat(settingsForm.graphqlUrl) &&
    matchesHttpUrlFormat(settingsForm.oauthRelayUrl)
)
