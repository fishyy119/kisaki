<!--
AniList Settings App is the webview root: tab navigation, preference draft
...
import {
  ...
  type AnilistSettingsFormState,
  type AnilistSettingsOverview
...
const overview = ref<AnilistSettingsOverview | null>(null)
const savedForm = ref<AnilistSettingsFormState | null>(null)
...
const isValid = computed(() => matchesHttpUrlFormat(settingsForm.graphqlUrl))
