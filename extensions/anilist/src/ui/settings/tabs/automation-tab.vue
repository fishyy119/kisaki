<!-- Automation Tab creates recommended app-owned automations for AniList commands. -->
<script setup lang="ts">
import { ref } from 'vue'
import { Badge, Button, Icon, SettingsSection, Spinner } from '@kisaki3/extension-ui-vue'
import type { AnilistAutomationKind, AnilistSettingsOverview } from '../../../shared/settings'
import { m } from '../i18n'
...
const creatingKind = ref<AnilistAutomationKind | null>(null)

async function create(kind: AnilistAutomationKind): Promise<void> {
