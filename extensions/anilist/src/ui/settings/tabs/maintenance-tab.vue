...
const isDefaultEndpoint = (): boolean => settingsForm.graphqlUrl === ANILIST_DEFAULT_GRAPHQL_URL
    ...
    >
      <FieldGroup>
        <Field
          ...
          :label="m.ui.maintenance.graphqlUrlLabel"
          :description="m.ui.maintenance.graphqlUrlDescription"
        >
          <Input
