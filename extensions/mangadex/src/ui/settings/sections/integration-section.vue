<!--
Integration Section owns the MangaDex reading connection: automatic push
preferences, the manual full push, and the status import. Long operations run
as app task runs; this section starts them and polls a small projection until
they settle.
-->
...
import type { MangadexProfileOption, MangadexTaskStateView } from '../../../shared/settings'
...
const task = ref<MangadexTaskStateView | null>(null)
        ...
        <FieldContent class="items-end gap-2">
          <div class="flex flex-row items-center gap-3">
            <label class="flex items-center gap-1.5 text-xs">
              ...
              {{ m.ui.integration.importScoresLabel }}
            </label>
            <label class="flex items-center gap-1.5 text-xs">
