...
const isDefaultEndpoint = (): boolean => settingsForm.apiUrl === MANGADEX_DEFAULT_API_URL

function restoreEndpoint(): void {
  settingsForm.apiUrl = MANGADEX_DEFAULT_API_URL
}
      ...
      <FieldGroup>
        ...
        >
          <Input
            ...
            autocomplete="off"
            spellcheck="false"
            :placeholder="MANGADEX_DEFAULT_API_URL"
            class="w-80"
          />
        </Field>
      </FieldGroup>
