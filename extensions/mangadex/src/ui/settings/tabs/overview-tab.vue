...
import type { MangadexSettingsOverview } from '../../../shared/settings'
...
const accountLabel = computed(() =>
  props.overview.account.configured
    ? m.value.ui.overview.connected
    : m.value.ui.overview.notConnected
)
...
const accountBadge = computed<{ label: string; variant: BadgeVariants['variant'] }>(() =>
  props.overview.account.configured
    ...
    : { label: m.value.ui.overview.notConnected, variant: 'secondary' }
)
