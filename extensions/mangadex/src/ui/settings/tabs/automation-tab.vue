<!-- Automation Tab creates recommended app-owned automations for MangaDex commands. -->
<script setup lang="ts">
import { ref } from 'vue'
import { Badge, Button, Icon, SettingsSection, Spinner } from '@kisaki3/extension-ui-vue'
import type { MangadexAutomationKind, MangadexSettingsOverview } from '../../../shared/settings'
import { m } from '../i18n'
...
interface Props {
  overview: MangadexSettingsOverview
}
...
const creatingKind = ref<MangadexAutomationKind | null>(null)

async function create(kind: MangadexAutomationKind): Promise<void> {
