<!-- Automation Tab creates recommended app-owned automations for Steam commands. -->
<script setup lang="ts">
import { ref } from 'vue'
import { Badge, Button, Icon, SettingsSection, Spinner } from '@kisaki3/extension-ui-vue'
import type { SteamAutomationKind, SteamSettingsOverview } from '../../../shared/settings'
import { m } from '../i18n'
...
const creatingKind = ref<SteamAutomationKind | null>(null)

async function create(kind: SteamAutomationKind): Promise<void> {
