 ...
 *
 * TMDB throttles bursts rather than publishing a quota, and one scrape fans
 * out into per-season and per-image reads, so requests are paced here instead
 * of relying on 429 retries alone.
 */
