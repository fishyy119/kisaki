...
// Optional props accept explicit `undefined` so consumers compiled with
// `exactOptionalPropertyTypes` can bind conditional values directly.
interface Props {
  orientation?: FieldVariants['orientation'] | undefined
  ...
  >
    ...
    >
      ...
      >
        ...
        <TooltipProvider v-if="props.help || props.link">
